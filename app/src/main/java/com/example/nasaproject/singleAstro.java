...
public class singleAstro extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //TODO: finish setting up recycler view for telemetry, may need to be moved; suggestion -
        //TODO: use a for-loop to iterate through the object indices to display each data point on
        //TODO: a separate row
